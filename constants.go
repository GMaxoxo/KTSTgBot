...
const (
	...
	BUTTON_TEXT_PRINT_INTRO       = EMOJI_BUTTON_START + "Смотреть вступление" + EMOJI_BUTTON_END
	...
	BUTTON_TEXT_USEFUL_ACTIVITIES = EMOJI_BUTTON_START + "Полезная деятальность" + EMOJI_BUTTON_END
